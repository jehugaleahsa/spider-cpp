...
spider-cpp: main.o http_request.o http_response.o url.o bad_url_exception.o page_downloader.o file_downloader.o
	g++ main.o http_request.o http_response.o url.o bad_url_exception.o page_downloader.o file_downloader.o -lboost_system -lboost_thread -lpthread -lboost_regex -o spider-cpp
